"use strict"
let PictureWindow = document.getElementById("PictureWindow");//divの取得(widthを大きくしたimg要素などが入っている)
let BigPicture = document.getElementById("Bigpicture");//imgの取得(widthを通常より大きくしたimg要素)
let StopS = document.getElementById("body");//bodyの取得。StopSはストップスクロールの略である(拡大中はスクロールを停止するための処理)
let CountTime;
let CD = 1;
